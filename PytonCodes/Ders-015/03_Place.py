...
btn_arti=Button(pencere,text="+",width=4,height=2,command=ftopla)
btn_arti.place(x=5,y=100)

fcikar=partial(Islem,"-")
btn_eksi=Button(pencere,text="-",width=4,height=2,command=fcikar)
btn_eksi.place(x=45,y=100)

fcarp=partial(Islem,"*")
btn_carp=Button(pencere,text="*",width=4,height=2,command=fcarp)
btn_carp.place(x=85,y=100)

fbol=partial(Islem,"/")
btn_bol=Button(pencere,text="/",width=4,height=2,command=fbol)
